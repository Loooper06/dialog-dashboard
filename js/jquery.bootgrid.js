    ...
    */
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            dropDownMenuItems: "dropdown-menu float-end", // must be a unique class name or constellation of class names within the actionDropDown
            ...
            right: "text-right",
            search: "search", // must be a unique class name or constellation of class names within the header and footer
        ...
        labels: {
            all: "همه",
            infos: "نمایش {{ctx.start}} تا {{ctx.end}} از {{ctx.total}} نتیجه",
         ...
         **/
        templates: {
            actionButton: "<button class=\"btn btn-outline-themecolor\" type=\"button\" title=\"{{ctx.text}}\">{{ctx.content}}</button>",
            actionDropDown: "<div class=\"{{css.dropDownMenu}}\"><button class=\"btn btn-outline-themecolor dropdown-toggle\" type=\"button\" data-bs-toggle=\"dropdown\"><span class=\"{{css.dropDownMenuText}}\">{{ctx.content}}</span> <span class=\"caret\"></span></button><ul class=\"{{css.dropDownMenuItems}}\" role=\"menu\"></ul></div>",
            ...
            paginationItem: "<li class=\"page-item {{ctx.css}}\"><a data-page=\"{{ctx.page}}\" class=\"{{css.paginationButton}}\">{{ctx.text}}</a></li>",
            rawHeaderCell: "<th class=\"{{ctx.css}}\">{{ctx.content}}</th>", // Used for the multi select box
            row: "<tr{{ctx.attr}}>{{ctx.cells}}</tr>",
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><span class=\"{{css.icon}} input-group-text {{css.iconSearch}}\"></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
...
$("[data-bs-toggle=\"bootgrid\"]").bootgrid();
})(jQuery, window);
...
;(function ($, window, undefined)
{
    ...
    $.extend($.fn.bootgrid.Constructor.defaults.css, {
        icon: "icon la",
        iconColumns: "la-th-list",
        iconDown: "la-sort-desc",
        iconRefresh: "la-refresh",
        iconSearch: "la-search",
        iconUp: "la-sort-asc"
});
})(jQuery, window);